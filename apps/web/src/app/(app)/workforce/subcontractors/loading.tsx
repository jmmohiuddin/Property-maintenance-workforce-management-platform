  ...
  return (
    <>
      ...
      <div className="container-page py-8" aria-busy="true" aria-live="polite">
        <p className="sr-only">Loading the subcontractor register.</p>
        <Bar width="12rem" height={12} />
        <h1 className="mt-4 text-2xl font-semibold tracking-tight md:text-3xl">Subcontractors and manpower suppliers</h1>
